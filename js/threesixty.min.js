!function (e) {
    ...
    e.ThreeSixty = function (t, r) {
        ...
        n.$el = e(t), n.el = t, n.$el.data("ThreeSixty", n), n.init = function () {
            ...
            }), a.styles && n.$el.css(a.styles), n.responsive(), n.$el.find(a.progress).css({marginTop: a.height / 2 - 15 + "px"}), n.$el.find(a.progress).fadeIn("slow"), n.$el.find(a.imgList).hide()
            ...
            if (a.disableWrap)a.endFrame = e, n.refresh(); else {
                var t = Math.ceil(a.endFrame / a.totalFrames);
                0 === t && (t = 1);
                var r = t > 1 ? a.endFrame - (t - 1) * a.totalFrames : a.endFrame, i = a.totalFrames - r, o = 0;
            ...
            var r = Math.log(a.totalFrames) / Math.LN10, n = 1e3, i = Math.round(r * n) / n, o = Math.floor(i) + 1;
            return t(e, o)
        }, n.browser = {}, n.browser.isIE = function () {
            var e = -1;
            if ("Microsoft Internet Explorer" === navigator.appName) {
                var t = navigator.userAgent, r = new RegExp("MSIE ([0-9]{1,}[\\.0-9]{0,})");
